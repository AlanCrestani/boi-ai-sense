...
export async function testHeaderMapping() {
    // Test configuration
    const config = {
        fields: {
            name: {
    ...
    const validRow = mapper.mapRow(['John Doe', '30', 'john@example.com'], validHeaders, 1);
    ...
    const invalidRow = mapper.mapRow(['Jane Doe', 'not_a_number', 'invalid_email'], invalidHeaders, 2);
    ...
    const dateRow = mapper.mapRow(['John', '30', '1993-01-15'], dateHeaders, 1);
    ...
    const unmappedRow = mapper.mapRow(['John', '30', 'value1', 'value2'], extraHeaders, 1);
