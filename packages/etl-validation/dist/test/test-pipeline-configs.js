...
export async function testPipelineConfigs() {
...
async function testPipeline02Config() {
...
async function testPipeline04Config() {
    ...
    const requiredFieldErrors = minimalRow.errors.filter(e => e.message.includes('Required field') &&
