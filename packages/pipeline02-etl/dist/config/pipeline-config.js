 ...
 */
export const DEFAULT_PIPELINE02_CONFIG = {
    database: {
 ...
 */
export function createPipeline02Config(environment = process.env.NODE_ENV || 'development', overrides = {}) {
 ...
 */
export function validatePipeline02Config(config) {
