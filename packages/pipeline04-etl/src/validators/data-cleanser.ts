...
export class Pipeline04DataCleanser {
   ...
   */
  private cleanDateField(value: any): { cleanedValue: string; warning?: Omit<CleansingWarning, 'field'> } {
    if (!value || value === '') {
      return { cleanedValue: '' };
    }
   ...
   */
  private cleanTimeField(value: any): { cleanedValue: string; warning?: Omit<CleansingWarning, 'field'> } {
    if (!value || value === '') {
      return { cleanedValue: '' };
    }
   ...
   * Clean turno field
   */
  private cleanTurnoField(value: any): { cleanedValue: string; warning?: Omit<CleansingWarning, 'field'> } {
    if (!value || value === '') {
      return { cleanedValue: '' };
    }
    ...
    const turnoMappings: Record<string, string> = {
      'MANHA': 'MANHÃ',
      'MANHÃ': 'MANHÃ',
      'MORNING': 'MANHÃ',
      'TARDE': 'TARDE',
   ...
   */
  private cleanCurralField(value: any): { cleanedValue: string; warning?: Omit<CleansingWarning, 'field'> } {
    if (!value || value === '') {
      return { cleanedValue: '' };
    }
   ...
   */
  private cleanTrateiroField(value: any): { cleanedValue: string; warning?: Omit<CleansingWarning, 'field'> } {
    if (!value || value === '') {
      return { cleanedValue: '' };
    }
  ...
  private cleanTrateiroFieldOLD(value: any): { cleanedValue: string; warning?: Omit<CleansingWarning, 'field'> } {
    if (!value || value === '') {
      return { cleanedValue: '' };
    }
   ...
   */
  private cleanDietaField(value: any): { cleanedValue: string | null; warning?: Omit<CleansingWarning, 'field'> } {
   ...
   */
  private cleanTipoTratoField(value: any): { cleanedValue: string; warning?: Omit<CleansingWarning, 'field'> } {
    if (!value || value === '') {
   ...
   */
  private cleanNumericField(value: any): { cleanedValue: number | null; warning?: Omit<CleansingWarning, 'field'> } {
   ...
   */
  private cleanTextField(value: any): { cleanedValue: string | null; warning?: Omit<CleansingWarning, 'field'> } {
    if (!value || value === '') {
      return { cleanedValue: null };
    }
