...
function runDataValidationTests() {
  ...
  const missingFieldsData: RawDesvioData = {
    turno: 'TARDE',
    dieta: 'Dieta Engorda',
  };
  ...
  const invalidEquipmentData: RawDesvioData = {
    data: '2024-01-15',
  ...
  const negativeWeightData: RawDesvioData = {
    data: '2024-01-15',
  ...
  const futureDateData: RawDesvioData = {
  ...
  const ddmmyyyyData: RawDesvioData = {
  ...
  const vagaoOnlyData: RawDesvioData = {
    data: '2024-01-15',
    equipamento: 'BAHMAN',
  ...
  const extremeDeviationData: RawDesvioData = {
    data: '2024-01-15',
    equipamento: 'BAHMAN',
    curral: 'C001',
    kg_planejado: 1000,
  ...
  const naturalKeyData: RawDesvioData = {
    data: '2024-01-15',
    turno: 'MANHA',
    equipamento: 'BAHMAN',
    curral: 'C001',
  ...
  const precisionData: RawDesvioData = {
    data: '2024-01-15',
    equipamento: 'BAHMAN',
    curral: 'C001',
  ...
  validationService.validateDesvioData(precisionData, context).then(result => {
    ...
    assert(Math.abs(result.cleanedData!.desvio_kg - expectedDeviation) < 0.01,
      `Should round deviation to 2 decimal places. Expected: ${expectedDeviation}, Got: ${result.cleanedData!.desvio_kg}`);
  }).catch(error => {
