...
export class ReferentialIntegrityService {
     ...
     */
    async checkReferentialIntegrity(data, organizationId) {
        const errors = [];
        const warnings = [];
     ...
     */
    async performAdditionalChecks(data, organizationId, errors, warnings) {
     ...
     */
    isPotentiallyDuplicateTrateiro(nome) {
     ...
     */
    async getReferentialIntegrityReport(organizationId) {
     ...
     */
    async batchCheckReferentialIntegrity(records, organizationId) {
        const results = [];
