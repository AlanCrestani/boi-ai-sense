...
export async function runPipeline02StateIntegrationTests() {
    ...
    try {
        ...
        try {
            ...
            const validationResult = await integration.validateData(sampleCSVData, context);
        ...
        try {
            const loadingResult = await integration.loadData(sampleCSVData, {
        ...
        try {
            ...
            await integration.transitionState(context, ETLState.UPLOADED, ETLState.PARSING, 'Test transition');
